...
public class CTFUser extends CTFObject implements ObjectWithTitle {
	 ...
	 * 
	 * This will only work if logged in as the user in question, or if the
	 * logged in user has superuser permissions.
	 * 
	 * <p>
	 * Because of the incompleteness in the API, this method cannot readily
	 * return {@link CTFGroup}s.
	 */
	public Set<String> getGroupNames() throws RemoteException {
		Set<String> groups = new HashSet<String>();
		GroupSoapList gList = app.icns.getUserGroupList(app.getSessionId(),
				userName);
